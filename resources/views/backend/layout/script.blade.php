...
<script src="{{url('backend/asset/js/plugins/fullcalendar.min.js')}}"></script>
<script src="{{url('backend/asset/js/plugins/jquery.nicescroll.js')}}"></script>
<script src="{{url('backend/asset/js/plugins/jquery.vmap.min.js')}}"></script>
<script src="{{url('backend/asset/js/plugins/maps/jquery.vmap.world.js')}}"></script>
<script src="{{url('backend/asset/js/plugins/jquery.vmap.sampledata.js')}}"></script>
<script src="{{url('backend/asset/js/plugins/chart.min.js')}}"></script>
